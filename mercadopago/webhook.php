...
curl_setopt_array($curl, [
    ...
    CURLOPT_TIMEOUT => 10, // Timeout de 10s
    CURLOPT_HTTPHEADER => [
...
if ($http_code !== 200) {
    error_log("[WEBHOOK] ❌ Erro ao consultar MP: HTTP $http_code");
    @file_put_contents($log_file, date('Y-m-d H:i:s') . " [ERRO] HTTP $http_code ao consultar payment $payment_id\n", FILE_APPEND);
