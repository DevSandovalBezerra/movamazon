...
// Parâmetros do retorno do Mercado Pago (extrair antes do redirect para passar na URL)
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p class="text-lg text-gray-600 mb-6">
                Seu pagamento foi processado com sucesso. Sua inscrição está confirmada!
            </p>
            ...
            <div class="mt-8 p-4 bg-blue-50 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div class="text-left">
                        <p class="text-sm font-medium text-blue-900 mb-1">Próximos passos</p>
                        <p class="text-sm text-blue-700">
                            Você receberá um email de confirmação em breve. Mantenha seu número de inscrição para o dia do evento.
                        </p>
                    </div>
                </div>
            </div>
