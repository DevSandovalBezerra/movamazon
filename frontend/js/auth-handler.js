...
function mostrarMensagemSessaoExpirada(mensagem, redirectUrl = '/frontend/paginas/auth/login.php') {
    ...
    // Redirecionar automaticamente apÒ³s 3 segundos
    setTimeout(() => {
...
/**
 * Verifica se o usuário estÒ¡ logado (verificação básica no frontend)
 * @returns {boolean}
 */
function verificarLoginFrontend() {
    // Esta Ò© uma verificação básica no frontend
