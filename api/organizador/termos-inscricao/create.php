...
try {
    ...
    $sql = "
        ...
        (evento_id, modalidade_id, titulo, conteudo, versao, ativo, data_criacao) 
        VALUES (?, ?, ?, ?, ?, ?, NOW())
    ";

    $stmt = $pdo->prepare($sql);
    $stmt->execute([$eventoId, $modalidadeId, $titulo, $conteudo, $versao, $ativo]);
    ...
    error_log('Erro ao criar termo: ' . $e->getMessage());
