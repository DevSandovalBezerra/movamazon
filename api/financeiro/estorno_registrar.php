...
$status = isset($body['status']) ? (string) $body['status'] : 'solicitado';
$gateway_refund_id = isset($body['gateway_refund_id']) ? (string) $body['gateway_refund_id'] : null;
...
try {
    ...
    error_log('Erro em estorno_registrar.php: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['success' => false, 'message' => 'Erro ao registrar estorno'], JSON_UNESCAPED_UNICODE);
}
