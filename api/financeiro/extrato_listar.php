...
try {
    $data = fin_extrato_listar($pdo, $evento_id, $filtros);
    echo json_encode(['success' => true, 'data' => $data], JSON_UNESCAPED_UNICODE);
} catch (Exception $e) {
    error_log('Erro ao listar extrato financeiro: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['success' => false, 'message' => 'Erro ao carregar extrato'], JSON_UNESCAPED_UNICODE);
}
