-- ==========================================================
-- Migracao: Modulo Assessoria de Corrida
-- Data: 2026-02-20
-- Descricao: Cria tabelas do modulo assessoria + papeis RBAC
...
CREATE TABLE IF NOT EXISTS `assessoria_atletas` (
  ...
  `data_fim` DATE NULL,
  `origem` ENUM('inscricao_evento','convite','manual') NOT NULL DEFAULT 'convite',
...
-- =========================
-- 2) ALTER TABLES EXISTENTES (com checagem para MySQL 5.7)
-- =========================
